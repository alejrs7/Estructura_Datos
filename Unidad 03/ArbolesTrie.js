/**
 * ============================================================
 *  LAB 11 - Árboles Trie (Prefix Trees) Sostenibles
 *  Motor de Autocompletado con enfoque Green Computing
 *  Uso de Map en lugar de Array[26] para ahorro de memoria
 * ============================================================
 */
...
class MotorAutocompletado {
  ...
  // Recorre el Trie letra por letra hasta llegar al nodo del prefijo
  ...
  // Punto de entrada: localiza el nodo del prefijo y lanza el DFS
...
// 2. Guía para la Simulación de Búsqueda

// --- Opción A: Llamadas individuales (Análisis de Precisión) ---
...
// Exportar para pruebas o uso en otros módulos (Node.js)
